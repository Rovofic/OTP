...
def get_arduino_command():
    ...
    if not arduino_cmd:
        if platform.system() == "Darwin":
            ...
            #  "C:\Users\Desarrollo\Documents\Desarrollo Repositorio\OTP\arduino-1.6.5-r2-windows\arduino-1.6.5-r2\Arduino_debug.exe",
            #  "C:\Users\Desarrollo\Documents\Desarrollo Repositorio\OTP\arduino-1.6.5-r2-windows\arduino-1.6.5-r2\Arduino.exe"
